const modulePageContent = {
    ...
    "modul1": {
        ...
        subtitle: "Frameworks & Risikobewertung bilden das Fundament des Sicherheitsmanagements.",
        navTitle: "Grundlagen",
        ...
        initLogic: () => {
            ...
            nistData.forEach(item => {
                ...
                div.className = 'diagram-item w-24 h-24 sm:w-28 sm:h-28 rounded-full text-white flex items-center justify-center text-center p-2 font-bold shadow-lg cursor-pointer';
    ...
    "modul2": {
        title: "Modul 2: Schwachstellenmanagement",
        subtitle: "Ein proaktiver und zyklischer Prozess zur Minimierung von Risiken.",
        navTitle: "Schwachstellen",
    ...
    "modul3": {
        title: "Modul 3: Patch-Management",
        subtitle: "Der strukturierte Prozess zur Anwendung von Software-Updates.",
        navTitle: "Patching",
        ...
        `
        // No initLogic for modul3 as it's purely static content
    },
    "modul4": {
        title: "Modul 4: CTI & Angriffsmodelle",
        subtitle: "Cyber Threat Intelligence und Angriffsmodelle helfen, Bedrohungen zu verstehen und proaktiv abzuwehren.",
        navTitle: "CTI & Angriffe",
        ...
        initLogic: () => {
            ...
            killchainData.forEach((item, index) => {
                const div = document.createElement('div');
                div.className = 'diagram-item p-3 w-full text-center bg-[var(--card-bg)] border border-[var(--card-border)] rounded-lg shadow-sm font-semibold text-[var(--text-secondary)] cursor-pointer';
    ...
    "modul5": {
        title: "Modul 5: Authentifizierung",
        subtitle: "Zentrale Protokolle und deren häufigste Angriffsvektoren.",
